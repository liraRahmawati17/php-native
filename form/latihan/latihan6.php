...
<form action="proses2.php" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <option value= "" >pilih</option>
            <option value= "Foto_Copy_KTP" > Fotocopy KTP</option>
            <option value=  "Foto_Copy_SIM" > Fotocopy SIM</option>
            <option value= "Foto_Copy_KK" > Fotocopy KK</option>
            </select></td>
        </tr>
        <tr>
            ...
            <option value= "" > mau menggunakan supir ?</option>
